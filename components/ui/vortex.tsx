...
export const Vortex = (props: VortexProps) => {
  ...
  const isLightBackground = () => {
    if (backgroundColor === "white" || backgroundColor === "#ffffff" || backgroundColor === "#FFFFFF") {
      return true;
    }
  ...
  const drawParticle = (
    ...
    if (lightBg) {
      ...
      // For dark backgrounds, use the original bright colors
  ...
  const renderGlow = (
    ...
    if (lightBg) {
      // For light backgrounds, use multiply to darken instead of lighter
